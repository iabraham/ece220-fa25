...
/* Function to write out data, arguments are filename on disk,
 * Pointer to array to write out and number of items to write */
...
int main(void) {
  /* Commented piece of code generated binary file */
